...
#ifndef RRC_CONTROL_PID_POSITION_CONTROLLER_H
#define RRC_CONTROL_PID_POSITION_CONTROLLER_H
...
class PidPositionController {
 public:
  ...
  PidPositionControllerParameters controller_parameters_;
...
#endif // RRC_CONTROL_PID_POSITION_CONTROLLER_H
